  ...
  return (
    <section className="relative overflow-hidden pt-12 pb-24">
      ...
      <div className="mx-auto max-w-6xl px-4">
        <TitleComponent
          badge={<span className="inline-flex items-center gap-2 rounded-full border border-border bg-bg-secondary/60 px-4 py-2 text-sm text-text-secondary backdrop-blur">
              <MessageCircle size={16} className="text-primary" />
              Contact us
            </span>}
          title="We’re here to help" description="Send your message and we’ll get back to you with the right guidance." align="center"
          className="max-w-2xl"
        />
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          ...
          <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.25 }} transition={{ duration: 0.5 }}
            className="relative overflow-hidden rounded-2xl border border-border bg-bg-main p-6">
            ...
            <h3 className="text-lg font-semibold text-text-primary">Quick support, clear answers</h3>
            <p className="mt-2 text-sm text-text-secondary leading-relaxed"> Whether it’s courses, payments, or access issues — we’ll guide you step by step. </p>
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              <div className="rounded-xl border border-border bg-bg-secondary/40 p-4">
                <div className="flex items-center gap-2 text-sm font-semibold text-text-primary">
                  <Clock3 size={16} className="text-primary" /> Response time </div>
                <p className="mt-1 text-xs text-text-muted"> Usually within 24h (weekdays) </p>
              </div>
              ...
              <div className="rounded-xl border border-border bg-bg-secondary/40 p-4">
                ...
                <p className="mt-1 text-xs text-text-muted"> Your data stays protected</p>
              </div>
            </div>
            ...
            <div className="mt-6 grid gap-3">
              {[
                ...
                <div key={x.title} className="flex items-start gap-3 rounded-xl border border-border bg-bg-secondary/40 p-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 text-xs text-text-secondary wrap-break-word"> {x.desc}</p>
                  </div>
                </div>
              ))}
            </div>           
          ...
          {/* Right form */}
          <motion.form initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.25 }} transition={{ duration: 0.55 }}
            onSubmit={(e) => e.preventDefault()} className=" rounded-2xl border border-border bg-bg-main p-6">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              <div className="sm:col-span-1">
                ...
                <input type="text" placeholder="Your name" className=" mt-2 h-11 w-full rounded-lg border border-border bg-bg-secondary/40 px-4 text-sm text-text-primary placeholder:text-text-muted outline-none
              ...
              <div className="sm:col-span-1">
                ...
                <input type="email" placeholder="you@example.com" className=" mt-2 h-11 w-full rounded-lg border border-border bg-bg-secondary/40 px-4 text-sm text-text-primary
              ...
              <div className="sm:col-span-2">
                ...
                <input type="text" placeholder="How can we help?" className="mt-2 h-11 w-full rounded-lg  border border-border bg-bg-secondary/40 px-4 text-sm text-text-primary placeholder:text-text-muted
              ...
              <div className="sm:col-span-2">
                ...
                <textarea rows={5} placeholder="Write your message..."
                  className=" mt-2 w-full rounded-lg border border-border bg-bg-secondary/40 px-4 py-3 text-sm text-text-primary placeholder:text-text-muted  outline-none
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <p className="text-xs text-text-muted"> By sending, you agree to our{" "}
